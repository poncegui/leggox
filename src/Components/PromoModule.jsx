          ...
          >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  {selectedProduct.brand || 'LEGGOX'} ·{' '}
                  {(selectedProduct.type || 'producto').toUpperCase()}
                </Mono>
                <Text
                  as="h2"
                  style={{
            ...
            >
              ...
              >
                {selectedProduct.imageSrc || selectedProduct.imageLargeSrc ? (
                  <>
                    <img
                      src={
                        selectedProduct.imageLargeSrc ||
                        selectedProduct.imageSrc
                      }
                      alt={selectedProduct.alt || selectedProduct.title}
                  ...
                  <Mono style={{ color: COLORS.darkGray, fontSize: 14 }}>
              ...
              >
                ...
                <Row style={{ gap: 8, flexWrap: 'wrap' }}>
                  ...
                  <StockPill inStock={Boolean(selectedProduct.inStock)} />
                </Row>
                ...
                <div
                  style={{
                    ...
                    borderRadius: 14,
                    padding: 16,
                    background: 'rgba(224,30,55,0.03)',
                  }}
                >
                  <Mono
                    style={{
                  ...
                  <Row
                    style={{ alignItems: 'baseline', gap: 12, marginTop: 8 }}
                  >
                    {selectedProduct.oldPrice &&
                    selectedProduct.oldPrice > selectedProduct.price ? (
                      <Text
                      ...
                      >
                        {formatEUR(selectedProduct.oldPrice)}
                      </Text>
                    ) : null}
                    <Text
                      style={{
                ...
                {Array.isArray(selectedProduct.vehicles) &&
                selectedProduct.vehicles.length > 0 ? (
                  <div
                    style={{
                ...
                {/* Botones de acción */}
                <Col style={{ gap: 10, marginTop: 'auto' }}>
                  {selectedProduct.inStock ? (
                    <a
                      href={selectedProduct.buyUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Comprar ${selectedProduct.title} en Mercagarage`}
                      style={{
                        display: 'inline-flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Solicitar información sobre ${selectedProduct.title}`}
                      style={{
                        display: 'inline-flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                    ...
                    >
                      ...
                      <IconWhatsApp size={16} color="#FFFFFF" />
                    </a>
                  )}
                  ...
                  >
                    🚚 Envío 24-48h península · 📦 Garantía de calidad
                  </Mono>
                </Col>
              </div>
            </div>
          ...
          {imageZoomed && (
            ...
            >
              ...
              >
                ...
                <img
                  src={
                    selectedProduct.imageLargeSrc || selectedProduct.imageSrc
                  }
                  alt={selectedProduct.alt || selectedProduct.title}
                  style={{
                    maxWidth: '95vw',
