...
export const Manguitos = [
  ...
  {
    /* Manguito llenado (Seat/Renault) moved to `otros` in products.js
       to avoid appearing in the buscador gallery. See products.js id:
       "manguito-silicona-llenado-seat-renault" */
  },
  /* variant removed */
  {},
  {
